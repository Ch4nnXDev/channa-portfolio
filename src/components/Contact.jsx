  ...
  return (
    <div id="contact" className='flex min-h-[74vh] min-w-full items-center justify-center'  >
      <div className='flex flex-col items-center justify-center gap-3 space-y-6 p-14' >
        ...
        <a href="mailto:clkarawita123@gmail.com" className='text-nowrap rounded-lg border-blue-600 bg-black px-5 py-3 text-lg font-bold text-white shadow-lg shadow-blue-300 transition-all duration-300 hover:-translate-y-2 hover:shadow-indigo-600' >Contact Me</a>
        <span className='text-nowrap rounded-lg border-blue-600 bg-blue px-5 py-3 text-lg font-bold text-white shadow-lg  transition-all duration-300 hover:-translate-y-2 hover:shadow-indigo-600'>+94 71 2770585</span>
      </div>
